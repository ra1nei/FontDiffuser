...
class ClassifierDataset(Dataset):
    def __init__(self, mode):   
        path_chinese1 = './datasets/my_data/train/chinese'
        path_english1 = './datasets/my_data/train/english'
        path_chinese2 = './datasets/my_data/test_unknown_style/chinese'
        path_english2 = './datasets/my_data/test_unknown_style/english'
        path_chinese3 = './datasets/my_data/test_unknown_content/chinese'
