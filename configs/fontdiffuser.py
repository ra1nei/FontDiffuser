...
def get_parser():
    ...
    parser.add_argument("--rsi_mode", type=str, default="rsi",
                        choices=["no_rsi", "rsi", "rsi_no_scale"],
                        help="Chọn chế độ RSI: 'no_rsi' (bỏ hẳn), 'rsi' (giữ, scale bằng deformable_scale)")
